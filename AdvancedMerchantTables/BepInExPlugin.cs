...
namespace AdvancedMerchantTables
{
	...
	public partial class BepInExPlugin : BaseUnityPlugin
	{
		...
		private void Awake()
		{
			...
			levelBasedLootWeighting = Config.Bind("Options", "LevelBasedLootWeighting", 0.3f, "Fraction weighting for preferring loot that matches the player level (1 is vanilla, only match with player level, and 0 means totally not level-matched). Preference is still for items with levels closer to the player.");
